  ...
  const classesData = [
    {
      ...
      title: 'Toddlers',
      age: 'Ages 3–5',
      description: 'The perfect first step into movement and confidence! Our toddler program uses fun, play-based gymnastics to develop essential motor skills in a safe and nurturing environment.',
      features: [
        'Develops basic movement skills',
        'Improves balance and coordination',
        'Builds confidence through guided activities',
